    ...
    switch (n) {
      ...
      case 2 /* TypeOrder.NumberValue */ :
        return function __PRIVATE_numberEquals(e, t, r) {
            ...
            let n, i;
            if ("doubleValue" in e && "doubleValue" in t) n = __PRIVATE_normalizeNumber(e.doubleValue), 
            i = __PRIVATE_normalizeNumber(t.doubleValue); else {
                if (!r?.S) return !1;
                n = __PRIVATE_normalizeNumber(e.integerValue ?? e.doubleValue), i = __PRIVATE_normalizeNumber(t.integerValue ?? t.doubleValue);
            }
            if (n === i) return !!r?.C || __PRIVATE_isNegativeZero(n) === __PRIVATE_isNegativeZero(i);
            return !!(void 0 === r || r.O) && (isNaN(n) && isNaN(i));
        }(e, t, r);
...
class CompositeFilter extends Filter {
    ...
    getFlattenedFilters() {
        return null !== this.L || (this.L = this.filters.reduce(((e, t) => e.concat(t.getFlattenedFilters())), [])), 
        this.L;
    }
...
class __PRIVATE_TargetImpl {
    constructor(e, t = null, r = [], n = [], i = null, s = null, o = null) {
        ...
        this.startAt = s, this.endAt = o, this.$ = null;
    }
}
...
class __PRIVATE_QueryImpl {
    ...
    constructor(e, t = null, r = [], n = [], i = null, s = "F" /* LimitType.First */ , o = null, a = null) {
        ...
        this.limit = i, this.limitType = s, this.startAt = o, this.endAt = a, this.B = null, 
 ...
 */ function __PRIVATE_queryNormalizedOrderBy(e) {
    ...
    if (null === t.B) {
        ...
        // Any explicit order by fields should be added as is.
                for (const r of t.explicitOrderBy) t.B.push(r), e.add(r.field.canonicalString());
 ...
 */ (t);
        ...
        // field to be sorted last.
                n.forEach((n => {
            e.has(n.canonicalString()) || n.isKeyField() || t.B.push(new OrderBy(n, r));
        })), 
        // Add the document key field to the last if it is not explicitly ordered.
        e.has(FieldPath$1.keyField().canonicalString()) || t.B.push(new OrderBy(FieldPath$1.keyField(), r));
    }
    return t.B;
}
 ...
 */ function __PRIVATE_queryToTarget(e) {
    const t = __PRIVATE_debugCast(e);
    return t.M || (t.M = __PRIVATE__queryToTarget(t, __PRIVATE_queryNormalizedOrderBy(e))), 
    t.M;
}
 ...
 */ function toNumber(e, t, r) {
    return Number.isInteger(t) && r?.preferIntegers || function isSafeInteger(e) {
 ...
 */ class __PRIVATE_DatastoreImpl extends Datastore {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */    I(e, t, r, n) {
        return this.W(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([i, s]) => this.connection.I(e, __PRIVATE_toResourcePath(t, r), n, i, s))).catch((e => {
    ...
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */    D(e, t, r, n, i) {
        return this.W(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([s, o]) => this.connection.D(e, __PRIVATE_toResourcePath(t, r), n, s, o, i))).catch((e => {
            throw "FirebaseError" === e.name ? (e.code === d.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), 
            this.appCheckCredentials.invalidateToken()), e) : new FirestoreError(d.UNKNOWN, e.toString());
        }));
    }
    terminate() {
        this.G = !0, this.connection.terminate();
    }
}
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, r) {
    const n = __PRIVATE_debugCast(e), {request: i, J: s, parent: o} = function __PRIVATE_toRunAggregationQueryRequest(e, t, r, n) {
        const {K: i, parent: s} = __PRIVATE_toQueryTarget(e, t), o = {}, a = [];
        let u = 0;
        return r.forEach((e => {
        ...
        t.U = __PRIVATE__queryToTarget(t, e.explicitOrderBy)), t.U;
    }(t), r);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const $ = "ComponentProvider", B = new Map;
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
    ...
    _toFieldTransform(e) {
        ...
        /*array=*/ !0), r = this.H.map((e => __PRIVATE_parseData(e, t))), n = new __PRIVATE_ArrayUnionTransformOperation(r);
        return new FieldTransform(e.path, n);
    }
    isEqual(e) {
        return e instanceof __PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.H, e.H);
    }
}
...
class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
    ...
    _toFieldTransform(e) {
        const t = __PRIVATE_createSentinelChildContext(this, e, 
        /*array=*/ !0), r = this.H.map((e => __PRIVATE_parseData(e, t))), n = new __PRIVATE_ArrayRemoveTransformOperation(r);
        return new FieldTransform(e.path, n);
    }
    isEqual(e) {
        return e instanceof __PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.H, e.H);
    }
}
...
class __PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
    ...
    isEqual(e) {
        return e instanceof __PRIVATE_NumericIncrementFieldValueImpl && (this.Y === e.Y || Number.isNaN(this.Y) && Number.isNaN(e.Y));
    }
}
...
class __PRIVATE_NumericMinimumFieldValueImpl extends FieldValue {
    ...
    isEqual(e) {
        return e instanceof __PRIVATE_NumericMinimumFieldValueImpl && (this.Y === e.Y || Number.isNaN(this.Y) && Number.isNaN(e.Y));
    }
}
...
class __PRIVATE_NumericMaximumFieldValueImpl extends FieldValue {
    ...
    isEqual(e) {
        return e instanceof __PRIVATE_NumericMaximumFieldValueImpl && (this.Y === e.Y || Number.isNaN(this.Y) && Number.isNaN(e.Y));
    }
}
...
/** Parse update data from a list of field/value arguments. */ function __PRIVATE_parseUpdateVarargs(e, t, r, n, i, s) {
    const a = e.createContext(1 /* UserDataSource.Update */ , t, r), u = [ __PRIVATE_fieldPathFromArgument(t, n, r) ], _ = [ i ];
    ...
    for (let e = u.length - 1; e >= 0; --e) if (!__PRIVATE_fieldMaskContains(c, u[e])) {
        ...
        const n = a.childContextForFieldPath(t);
 ...
 */ (e, t), null;
    ...
    return function __PRIVATE_parseScalarValue(e, t, r) {
        ...
        if ("number" == typeof e) return toNumber(t.serializer, e, r);
 ...
 */ function __PRIVATE_fieldPathFromDotSeparatedString(e, t, r) {
    if (t.search(k) >= 0) throw createError(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`, e, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
